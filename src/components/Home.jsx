    ...
    <div name="home" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 '>
      <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full pl-8 pr-2 md:flex-row'>
        <div className='flex flex-col  justify-center h-full '>
          <p className='text-xl text-white py-3 font-semibold'>Hey, My Name is</p>
          <h2 className='display: inline-block text-4xl sm:text-4xl font-bold text-white '>Nitesh Louvanshi  </h2>
          <p className='text-gray-500 py-4 max-w-md'>I focus on creating web applications that prioritize user experience and align with the specific needs of clients.</p>
        ...
        <div>
        <img src={Hero} alt="my profile" className=' rounded-full mx-auto w-2/5  md:w-2/5' />
        </div>
